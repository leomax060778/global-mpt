...
function insertLevel2(budget, acronym, organizationName, implementExecutionLevel, crtRelated, hl1Id, inBudget, allowAutomaticBudgetApproval, userId, importId, imported){
	var parameters = {};
...
function updateLevel2(hl2Id, hl2BudgetTotal, organizationAcronym, organizationName, implementExecutionLevel, crtRelated, inBudget, allowAutomaticBudgetApproval, version, userId){
	var parameters = {};
