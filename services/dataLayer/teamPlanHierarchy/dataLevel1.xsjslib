...
function insertLevel1(acronym, description, budgetYearId, regionId, subregionId, userId, budget, teamTypeId, implementExecutionLevel, crtRelated, import_id, imported) {
    var parameters = {};
    var result = {};
