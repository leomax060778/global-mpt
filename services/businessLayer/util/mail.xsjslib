...
"CC":[{"address":"info@gmail.com"},{"address":"info2@gmail.com"}],   --OPTIONAL--
"BCC":[{"address":"info@gmail.com"},{"address":"info2@gmail.com"}],    --OPTIONAL--
}
 * */
...
function validate(value){
		 ...
		 var error = "";	
			...
			if(!validateEmail(value.FROM)) error = error +"-the From value is not a email address";
