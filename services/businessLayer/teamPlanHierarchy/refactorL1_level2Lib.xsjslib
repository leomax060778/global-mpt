...
var hl3 = mapper.refactorL1_getLevel3();
...
var dataExOut = mapper.refactorL1_getDataExpectedOutcome();
...
var blLevel1 = mapper.refactorL1_getLevel1();
...
function deleteHl2(objLevel2, userId) {
    ...
    if (!util.validateIsNumber(hl2Id))
        throw ErrorLib.getErrors().CustomError("", "hl2Services/handlePost/deleteHl2", L1_MSG_PLAN_NOT_FOUND);
    if (hasChild(objLevel2))
        throw ErrorLib.getErrors().CustomError("", "hl2Services/handlePost/deleteHl2", L1_MSG_PLAN_CANT_DELETE);

    contactDataLib.deleteContactDataByContactTypeId("soft", "CENTRAL", hl2Id, userId);
    dataExOut.deleteHl2ExpectedOutcomesDetail(hl2Id, userId);
    dataExOut.deleteHl2ExpectedOutcomes(hl2Id, userId);
    dataCategoryOptionLevel.deleteCategoryOption(hl2Id, userId, 'HL2');
...
function updateExpectedOutcomes(data, userId) {
    dataExOut.deleteHl2ExpectedOutcomesDetail(data.HL2_ID, userId);
    dataExOut.deleteHl2ExpectedOutcomes(data.HL2_ID, userId);
