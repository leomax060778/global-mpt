...
function insertSegmentationForm(segmentationFormInfo, userId) {
    ...
    var segmentationFormId = data.insertSegmentationForm(
        ...
        segmentationFormInfo.ORGANIZATION_ID || segmentationFormInfo.REGION_ID || null,
        segmentationFormInfo.SUBREGION_ID || null,
        segmentationFormInfo.COUNTRY_ID || null,
        ...
        Number(segmentationFormInfo.ACCEPT_TERMS_STATE) || 0,
        userId,
