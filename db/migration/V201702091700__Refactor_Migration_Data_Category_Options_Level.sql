...
CALL "MKTG_PLANNING_TOOL"."mktgplanningtool.db.procedures::DELETE_CONSTRAINT"('HL4_CATEGORY_OPTION','OPTION');
CALL "MKTG_PLANNING_TOOL"."mktgplanningtool.db.procedures::DELETE_CONSTRAINT"('HL5_CATEGORY_OPTION','OPTION');
CALL "MKTG_PLANNING_TOOL"."mktgplanningtool.db.procedures::DELETE_CONSTRAINT"('HL6_CATEGORY_OPTION','OPTION');

CALL "MKTG_PLANNING_TOOL"."mktgplanningtool.db.procedures::DELETE_CONSTRAINT"('HL4_CATEGORY_OPTION','HL4_CATEGORY');
CALL "MKTG_PLANNING_TOOL"."mktgplanningtool.db.procedures::DELETE_CONSTRAINT"('HL5_CATEGORY_OPTION','HL5_CATEGORY');
CALL "MKTG_PLANNING_TOOL"."mktgplanningtool.db.procedures::DELETE_CONSTRAINT"('HL6_CATEGORY_OPTION','HL6_CATEGORY');
--drop procedure from BD
DROP PROCEDURE "MKTG_PLANNING_TOOL"."mktgplanningtool.db.procedures::DELETE_CONSTRAINT" ;

-- BK
--ALTER TABLE "MKTG_PLANNING_TOOL"."HL4_CATEGORY_OPTION" ADD FOREIGN KEY ( "OPTION_ID" ) REFERENCES "MKTG_PLANNING_TOOL"."OPTION" ("OPTION_ID") ON UPDATE RESTRICT ON DELETE RESTRICT;
--ALTER TABLE "MKTG_PLANNING_TOOL"."HL4_CATEGORY_OPTION" ADD FOREIGN KEY ( "HL4_CATEGORY_ID" ) REFERENCES "MKTG_PLANNING_TOOL"."HL4_CATEGORY" ("HL4_CATEGORY_ID") ON UPDATE RESTRICT ON DELETE RESTRICT;
...
ALTER TABLE "MKTG_PLANNING_TOOL"."HL4_CATEGORY_OPTION" ALTER ("ALLOCATION_CATEGORY_OPTION_LEVEL_ID" BIGINT NOT NULL);
ALTER TABLE "MKTG_PLANNING_TOOL"."HL5_CATEGORY_OPTION" ALTER ("ALLOCATION_CATEGORY_OPTION_LEVEL_ID" BIGINT NOT NULL);
ALTER TABLE "MKTG_PLANNING_TOOL"."HL6_CATEGORY_OPTION" ALTER ("ALLOCATION_CATEGORY_OPTION_LEVEL_ID" BIGINT NOT NULL);

ALTER TABLE "MKTG_PLANNING_TOOL"."HL4_CATEGORY_OPTION" ALTER ("HL4_CATEGORY_ID" BIGINT NULL);
ALTER TABLE "MKTG_PLANNING_TOOL"."HL4_CATEGORY_OPTION" ALTER ("OPTION_ID" BIGINT NULL);

ALTER TABLE "MKTG_PLANNING_TOOL"."HL5_CATEGORY_OPTION" ALTER ("HL5_CATEGORY_ID" BIGINT NULL);
ALTER TABLE "MKTG_PLANNING_TOOL"."HL5_CATEGORY_OPTION" ALTER ("OPTION_ID" BIGINT NULL);

ALTER TABLE "MKTG_PLANNING_TOOL"."HL6_CATEGORY_OPTION" ALTER ("HL6_CATEGORY_ID" BIGINT NULL);
ALTER TABLE "MKTG_PLANNING_TOOL"."HL6_CATEGORY_OPTION" ALTER ("OPTION_ID" BIGINT NULL);
