create column table "MKTG_PLANNING_TOOL"."HL1_VERSION" (
...
create column table "MKTG_PLANNING_TOOL"."HL2_VERSION" (
...
create column table "MKTG_PLANNING_TOOL"."HL3_VERSION" (
