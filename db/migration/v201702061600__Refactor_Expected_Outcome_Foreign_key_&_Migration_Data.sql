...
ALTER TABLE "MKTG_PLANNING_TOOL"."HL4_EXPECTED_OUTCOMES_DETAIL" ADD ("OUTCOMES_ID_PROXY" BIGINT NULL);
ALTER TABLE "MKTG_PLANNING_TOOL"."HL5_EXPECTED_OUTCOMES_DETAIL" ADD ("OUTCOMES_ID_PROXY" BIGINT NULL);
ALTER TABLE "MKTG_PLANNING_TOOL"."HL6_EXPECTED_OUTCOMES_DETAIL" ADD ("OUTCOMES_ID_PROXY" BIGINT NULL);
...
UPDATE HL4_EXPECTED_OUTCOMES_DETAIL
   ...
   (
   	...
   	(
   		...
   		from "MKTG_PLANNING_TOOL"."OUTCOMES" ou
   		inner join "MKTG_PLANNING_TOOL"."OUTCOMES_TYPE" ot on ot.OUTCOMES_TYPE_ID = ou.OUTCOMES_TYPE_ID
   	...
   	(
   		...
   		, eoo.NAME
   		from "MKTG_PLANNING_TOOL"."EXPECTED_OUTCOME_LEVEL" eol
   		inner join "MKTG_PLANNING_TOOL"."EXPECTED_OUTCOME_OPTION" eoo on eoo.EXPECTED_OUTCOME_OPTION_ID = eol.EXPECTED_OUTCOME_OPTION_ID
...
RENAME COLUMN  "MKTG_PLANNING_TOOL"."HL4_EXPECTED_OUTCOMES_DETAIL"."OUTCOMES_ID" TO "OUTCOMES_ID_BKP";

--RENAME COLUMN OUTCOMES_ID_PROXY TO OUTCOMES_ID
RENAME COLUMN  "MKTG_PLANNING_TOOL"."HL4_EXPECTED_OUTCOMES_DETAIL"."OUTCOMES_ID_PROXY" TO "OUTCOMES_ID";

--RENAME COLUMN OUTCOMES_ID TO OUTCOMES_ID_BKP
RENAME COLUMN  "MKTG_PLANNING_TOOL"."HL5_EXPECTED_OUTCOMES_DETAIL"."OUTCOMES_ID" TO "OUTCOMES_ID_BKP";

--RENAME COLUMN OUTCOMES_ID_PROXY TO OUTCOMES_ID
RENAME COLUMN  "MKTG_PLANNING_TOOL"."HL5_EXPECTED_OUTCOMES_DETAIL"."OUTCOMES_ID_PROXY" TO "OUTCOMES_ID";


--RENAME COLUMN OUTCOMES_ID TO OUTCOMES_ID_BKP
RENAME COLUMN  "MKTG_PLANNING_TOOL"."HL6_EXPECTED_OUTCOMES_DETAIL"."OUTCOMES_ID" TO "OUTCOMES_ID_BKP";

--RENAME COLUMN OUTCOMES_ID_PROXY TO OUTCOMES_ID
RENAME COLUMN  "MKTG_PLANNING_TOOL"."HL6_EXPECTED_OUTCOMES_DETAIL"."OUTCOMES_ID_PROXY" TO "OUTCOMES_ID";

--
ALTER TABLE "MKTG_PLANNING_TOOL"."HL4_EXPECTED_OUTCOMES_DETAIL" ALTER (OUTCOMES_ID_BKP bigint NULL);
ALTER TABLE "MKTG_PLANNING_TOOL"."HL5_EXPECTED_OUTCOMES_DETAIL" ALTER (OUTCOMES_ID_BKP bigint NULL);
ALTER TABLE "MKTG_PLANNING_TOOL"."HL6_EXPECTED_OUTCOMES_DETAIL" ALTER (OUTCOMES_ID_BKP bigint NULL);

--add comment to tables abaut this change
comment on column "MKTG_PLANNING_TOOL"."HL4_EXPECTED_OUTCOMES_DETAIL"."OUTCOMES_ID" is 'FK to EXPECTED_OUTCOME_LEVEL';
comment on column "MKTG_PLANNING_TOOL"."HL5_EXPECTED_OUTCOMES_DETAIL"."OUTCOMES_ID" is 'FK to EXPECTED_OUTCOME_LEVEL';
comment on column "MKTG_PLANNING_TOOL"."HL6_EXPECTED_OUTCOMES_DETAIL"."OUTCOMES_ID" is 'FK to EXPECTED_OUTCOME_LEVEL';
