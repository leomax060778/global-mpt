...
create column table "MKTG_PLANNING_TOOL"."BUSGET_SPEND_REQUEST_OTHER_BUDGET_APPROVER" (
        "BUSGET_SPEND_REQUEST_OTHER_BUDGET_APPROVER_ID" bigint not null primary key generated by default as IDENTITY,
        "OTHER_BUDGET_APPROVER_ID" bigint not null,
        "BUSGET_SPEND_REQUEST_ID" bigint not null,
        ...
        FOREIGN KEY ("BUSGET_SPEND_REQUEST_ID") REFERENCES "MKTG_PLANNING_TOOL"."BUSGET_SPEND_REQUEST"("BUSGET_SPEND_REQUEST_ID")
);
