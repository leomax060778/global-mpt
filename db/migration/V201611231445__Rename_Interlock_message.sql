...
RENAME COLUMN "MKTG_PLANNING_TOOL".INTERLOCK_REQUEST_MESSAGE.INTERLOCK_CONTACT_DATA_ID TO "INTERLOCK_REQUEST_ID";
...
CREATE COLUMN TABLE "MKTG_PLANNING_TOOL"."INTERLOCK_REQUEST_ORIGIN" (
...
-- Update the interlock request origin for Requester
INSERT INTO INTERLOCK_REQUEST_MESSAGE (INTERLOCK_REQUEST_ID,CREATED_USER_ID, SENDER_ID,INTERLOCK_REQUEST_ORIGIN_ID,
MESSAGE, CREATED_DATE_TZ)
SELECT INTERLOCK_REQUEST_ID,CREATED_USER_ID,CREATED_USER_ID, 1, REQUESTED_RESOURCE, CREATED_DATE_TZ
