CREATE COLUMN TABLE "MKTG_PLANNING_TOOL"."EXPECTED_OUTCOME" (
...
CREATE COLUMN TABLE "MKTG_PLANNING_TOOL"."EXPECTED_OUTCOME_OPTION" (
...
CREATE COLUMN TABLE "MKTG_PLANNING_TOOL"."EXPECTED_OUTCOME_LEVEL" (
        ...
        FOREIGN KEY ("EXPECTED_OUTCOME_ID") REFERENCES "MKTG_PLANNING_TOOL"."EXPECTED_OUTCOME"("EXPECTED_OUTCOME_ID"),
        FOREIGN KEY ("EXPECTED_OUTCOME_OPTION_ID") REFERENCES "MKTG_PLANNING_TOOL"."EXPECTED_OUTCOME_OPTION"("EXPECTED_OUTCOME_OPTION_ID")
);
