create column table "MKTG_PLANNING_TOOL"."ALLOCATION_CATEGORY" (
...
create column table "MKTG_PLANNING_TOOL".ALLOCATION_OPTION (
...
create column table "MKTG_PLANNING_TOOL".ALLOCATION_CATEGORY_OPTION_LEVEL(
