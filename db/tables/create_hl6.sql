...
;
ALTER TABLE "MKTG_PLANNING_TOOL"."HL6" ADD FOREIGN KEY ( "HL5_ID" ) REFERENCES "MKTG_PLANNING_TOOL"."HL5" ("HL5_ID") ON UPDATE RESTRICT ON DELETE RESTRICT
;
...
;
ALTER TABLE "MKTG_PLANNING_TOOL"."HL6" ADD FOREIGN KEY ( "EURO_CONVERSION_ID" ) REFERENCES "MKTG_PLANNING_TOOL"."EURO_CONVERSIONS" ("EURO_CONVERSION_ID") ON UPDATE RESTRICT ON DELETE RESTRICT
;
