CREATE COLUMN TABLE "MKTG_PLANNING_TOOL"."ROLE" ("ROLE_ID" BIGINT CS_FIXED GENERATED BY DEFAULT AS IDENTITY NOT NULL ,
	 "NAME" NVARCHAR(255),
	 ...
	 PRIMARY KEY ("ROLE_ID")) UNLOAD PRIORITY 5 AUTO MERGE